...
namespace DT.Samples.Agora.OneToOne.iOS
{
	public partial class RoomViewController : UIViewController
	{
		...
		public override void ViewDidLoad()
		{
			...
			AgoraKit.SetChannelProfile(AgoraRtcChannelProfile.Communication);
			AgoraKit.EnableVideo();
			var profile = AgoraSettings.Current.UseMySettings ? AgoraSettings.Current.Profile.ToAgoraRtcVideoProfile() : AgoraRtcVideoProfile.Default;
			...
			AgoraKit.JoinChannelByKey(AgoraTestConstants.AgoraAPI, AgoraSettings.Current.RoomName, null, 0, JoiningCompleted);
		}
		...
		public void DidOfflineOfUid(AgoraRtcEngineKit engine, nuint uid, AgoraRtcUserOfflineReason reason)
		{
